          ...
          <div className="card-container" key={location.id}>
            <div className="card-wrapper">
              ...
              <p className="card-text">
                ...
                voluptatibus cupiditate atque vitae unde perspiciatis mollitia
                vero saepe nesciunt suscipit magni excepturi repellat accusamus,
                id at in ipsum fugit vel facilis similique praesentium?{" "}
              </p>
              <button
              ...
              >
                {location.status === "available" ? "Se vask" : "Lukket"}
              </button>
            </div>
          </div>
        );
